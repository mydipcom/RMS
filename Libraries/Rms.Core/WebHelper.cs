...
namespace Rms.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["Rms.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["Rms.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["Rms.IsPOSTBeingDone"] = value;
            }
        }
