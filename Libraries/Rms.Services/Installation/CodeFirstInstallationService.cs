...
using Rms.Core.Domain.Payments;
...
namespace Rms.Services.Installation
{
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>()
            {
                new ScheduleTask()
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "Rms.Services.Messages.QueuedMessagesSendTask, Rms.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask()
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "Rms.Services.Common.KeepAliveTask, Rms.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask()
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "Rms.Services.Customers.DeleteGuestsTask, Rms.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask()
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "Rms.Services.Caching.ClearCacheTask, Rms.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask()
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Rms.Services.Logging.ClearLogTask, Rms.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask()
                {
                    ...
                    Seconds = 900,
                    Type = "Rms.Services.Directory.UpdateExchangeRateTask, Rms.Services",
                    Enabled = true,
                    StopOnError = false,
                },
            };
