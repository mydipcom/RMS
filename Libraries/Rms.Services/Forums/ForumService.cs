...
namespace Rms.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string FORUMGROUP_ALL_KEY = "Rms.forumgroup.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : forum group ID
        /// </remarks>
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "Rms.forum.allbyforumgroupid-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUMGROUP_PATTERN_KEY = "Rms.forumgroup.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUM_PATTERN_KEY = "Rms.forum.";
